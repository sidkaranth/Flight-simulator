...
<body background="fly.jpg">
  ...
  <div class="input-grp"> 
   <div class="input-grp">
   <button type="submit" class="btn btn-primary-flight" id="done" name="done">Book</button>
  </div>
   
  <!-- <h1> To book tickets u have to register with us </h1> -->
   </form>
  </div>
   ...
   <a href="cancel.php"> <input type="button" id="btn1" value="CANCEL"></a>
   </div>
